...
try:
    from .tracing import inject_context, optional_span
except ImportError:
...
class InferenceRelay:
    ...
    async def dispatch(
        ...
        *,
        ...
        with optional_span(
            "relay.dispatch",
            attributes={"session_id": session_id, "worker_id": worker_id},
        ) as span:
            ...
            timing["dispatched_at"] = dispatched_at
            timing["relay_round_trip_ms"] = round(relay_round_trip_ms, 2)

            if span:
                span.set_attribute("relay_round_trip_ms", timing["relay_round_trip_ms"])
